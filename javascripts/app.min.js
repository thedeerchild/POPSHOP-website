...
/* webcam.js */
var makeLivestream=function(){var a=$("#livestream-modal").width(),b=0.75*a;$("#livestream-container").height(b+"px");a='<object width="'+a+'" height="'+b+'"><param name="movie" value="https://www.dropcam.com/e/76153ef8fad04a2f809ddb65e40c32ba?autoplay=true"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><param name="wmode" value="opaque"></param><embed src="https://www.dropcam.com/e/76153ef8fad04a2f809ddb65e40c32ba?autoplay=true" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="'+a+'" height="'+b+'" wmode="opaque"></embed></object>';$("#livestream-container").html(a)};
/* bio-data.js */
